...
from processors.utils_ner import CNerTokenizer, get_entities, get_entities2, get_entities3
...
def predict(args, model, tokenizer, prefix=""):
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        label_entities = get_entities2(preds, args.id2label, args.markup)
        json_d = {}
        json_d['id'] = step
...
def main():
    parser = get_argparse()
    parser.add_argument("--output_dir", default="outputs/cluener_crf",
                        type=str,
    ...
    init_logger(log_file=args.output_dir + f'/{args.model_type}-{args.task_name}.log')
