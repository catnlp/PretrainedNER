...
from processors.utils_ner import CNerTokenizer, get_entities, get_entities3, get_entities2
...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            inputs = {"input_ids": batch[0], "attention_mask": batch[1], "labels": batch[3], "weight": args.weight.to(args.device)}
...
def predict(args, model, tokenizer, prefix=""):
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        label_entities = get_entities3(preds, args.id2label, args.markup)
        json_d = {}
        json_d['id'] = step
...
def main():
    ...
    # Required parameters
    parser.add_argument("--task_name", default="msra", type=str,
                        help="The name of the task to train selected in the list: ")
    parser.add_argument("--data_dir", default="data/msra/json", type=str,
    ...
    parser.add_argument("--output_dir", default="outputs/cluener_softmax_msra", type=str,
    ...
    parser.add_argument("--logging_steps", type=int, default=2240,
                        help="Log every X updates steps.")
    parser.add_argument("--save_steps", type=int, default=2240, help="Save checkpoint every X updates steps.")
    parser.add_argument("--eval_all_checkpoints", default=True, type=bool,
                        help="Evaluate all checkpoints starting with the same prefix as model_name ending and ending with step number", )
    parser.add_argument("--predict_checkpoints",type=int, default=1568,
    ...
    for label in label_list:
        if label[0] in "BSE":
            ...
            weight.append(1.0)
    args.weight = torch.FloatTensor(weight)
    print(args.weight)
