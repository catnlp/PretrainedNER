...
from processors.utils_ner import get_entities1, get_entities2, get_entities3
...
class SeqEntityScore(object):
    ...
    def update(self, label_paths, pred_paths):
        ...
        for label_path, pre_path in zip(label_paths, pred_paths):
            label_entities = get_entities1(label_path, self.id2label,self.markup)
            pre_entities = get_entities3(pre_path, self.id2label,self.markup)
