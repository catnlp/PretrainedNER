...
def get_argparse():
    ...
    parser.add_argument("--data_dir", default="CLUEdatasets/cluener", type=str,
    ...
    parser.add_argument("--logging_steps", type=int, default=224,
                        help="Log every X updates steps.")
    parser.add_argument("--save_steps", type=int, default=224, help="Save checkpoint every X updates steps.")
