...
import copy
import json
from .utils_ner import NerDataProcessor
...
class CnerProcessor(NerDataProcessor):
...
class CluenerProcessor(NerDataProcessor):
    """Processor for the chinese ner data set."""

    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_clue(os.path.join(data_dir, "train.json")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_clue(os.path.join(data_dir, "dev.json")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_clue(os.path.join(data_dir, "test.json")), "test")
    ...
    def get_labels(self):
        ...
        return ["X", "B-address", "B-book", "B-company", 'B-game', 'B-government', 'B-movie', 'B-name',
                ...
                "E-address", "E-book", "E-company", 'E-game', 'E-government',
                'E-movie', 'E-name', 'E-organization', 'E-position', 'E-scene',
...
class MsraProcessor(NerDataProcessor):
    """Processor for the chinese ner data set."""
